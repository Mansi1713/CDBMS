...
class DBMS
{
    ...
    public void  desc()
    {
        ...
        System.out.println("Information of the table with the column names/description:");
        System.out.println("Rno  :Primary key");
        System.out.println("Name  :varchar");
        System.out.println("City  :varchar" );
        System.out.println("Marks :Integer");        
    
    }
    public void Selectmarkrsbetween()
    {
        //System.out.println("Data from the student table where city is : "+str);

        node temp = first;

        System.out.println("-------------------Data between given Range for marks-------------------------");
        while(temp != null)
        {
            
            if(temp.Marks>=90 && temp.Marks<=95)
            {
    ...
    public void Selectlimit(int id)
    {
        ...
        System.out.println("Information of  students with the name till the limit:");
        while(temp != null)
        {
            if(temp.Rno<=id)
            {
    ...
    public void Selectmarkrsnotbetween()
    {
        //System.out.println("Data from the student table where city is : "+str);

        node temp = first;

        System.out.println("----------Data Not between given Range for marks---------");
        while(temp != null)
        {
...
class CDBMS
{
    public static void main(String Arg[])
    {
        ...
        obj.Selectmarkrsbetween();

        obj.Selectlimit(3);

        obj.Selectmarkrsnotbetween();
    }
}
...
11 : delete from student where Rno = ___;
12 :desc table name;
13: select rno,name from student where marks between __ to ___;
14:Limit function will limit to fetch the record from the table';
15: select rno,name from student where marks not  between __ to ___;
